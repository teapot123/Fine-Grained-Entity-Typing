...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='bbn')
    ...
    with open(os.path.join('results', dataset, save_res), 'a') as fout:
        ...
        for i in range(20):
            ...
            # test_file = os.path.join('data', dataset, dataset+'_test_new_5_0.json')
        ...
        train_acc_average /= 20
        train_micro_f1_average /= 20
        train_macro_f1_average /= 20
        test_acc_average /= 20
        test_micro_f1_average /= 20
        test_macro_f1_average /= 20
